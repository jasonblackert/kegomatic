...
class FlowMeter():
    ...
    def getFlow(self):
        if(self.displayFormat == 'metric'):
            return round(self.flow, 5)
        else:
            return round(self.flow * FlowMeter.PINTS_IN_A_LITER, 3)
    ...
    def getThisPour(self):
        if(self.displayFormat == 'metric'):
            ...
            return round(self.thisPour * FlowMeter.PINTS_IN_A_LITER, 3)
    ...
    def getTotalPour(self):
        if(self.displayFormat == 'metric'):
            return round(self.totalPour, 3)
        else:
            return round(self.totalPour * FlowMeter.PINTS_IN_A_LITER, 3)
